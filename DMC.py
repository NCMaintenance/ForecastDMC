...
def prepare_data_enhanced(df):
    ...
    df['Additional_Capacity_2pm'] = df['Additional_Capacity_8am']
    df['Additional_Capacity_8pm'] = df['Additional_Capacity_8am']
...
def forecast_additional_capacity(historical_data, future_df, features):
    ...
    capacity_data = capacity_data[capacity_data['Additional_Capacity'] > 0]
